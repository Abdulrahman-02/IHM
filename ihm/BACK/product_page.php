...
$requete=$_nft->requete($_GET["category"],$_GET["budget"],$_GET["chain"],$_GET["reset"]);
...
<html>
  ...
  <body>
    ...
    <form action="" method="GET"> 
        <div style="width:100%;text-align:center;font-size:25px;border-bottom-width: 0.5px;border-color:white;">
          ...
          <div class="products_container">
                ...
                <?php 
                        if(isset($_GET["filterr"])){
                            ?><a href="product_page.php?reset=1"  class="buttonDownload" >Reset Filter</a><?php
                        }
                ?>
                <div class="container">
